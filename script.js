...
const account1 = {
  ...
  movementsDates: [
    ...
    "2023-07-03T07:42:02.383Z",
    "2023-07-07T09:15:04.904Z",
    "2023-06-10T10:17:24.185Z",
    "2023-05-08T14:11:59.604Z",
    "2023-07-05T17:01:17.194Z",

    "2023-07-10T00:00:00.929Z",
...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    //Stop the timer when arrives to 0
    if (time === 0) {
...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    inputLoginPin.blur(); // الان چی کار کرد؟؟؟؟؟
...
const calcDisplaySummary = function (acc) {
  ...
  labelSumIn.textContent = formatNum(incomes, acc.locale, acc.currency);
  const outcomes = acc.movements
    .filter((mov) => mov < 0)
    .reduce((acc, mov) => acc + mov, 0);
  labelSumOut.textContent = formatNum(outcomes, acc.locale, acc.currency);
